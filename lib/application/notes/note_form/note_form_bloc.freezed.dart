...
class _$NoteFormEventTearOff {
  ...
  _ColorChanged coloryChanged(Color color) {
...
mixin _$NoteFormEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result coloryChanged(Color color),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result coloryChanged(Color color),
  ...
  Result map<Result extends Object>({
    ...
    @required Result coloryChanged(_ColorChanged value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result coloryChanged(_ColorChanged value),
...
class _$_ColorChanged implements _ColorChanged {
  ...
  @override
  String toString() {
    return 'NoteFormEvent.coloryChanged(color: $color)';
  }
